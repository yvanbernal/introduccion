...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\yvanb\OneDrive\Escritorio\Python\introduccion\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\yvanb\OneDrive\Escritorio\Python\introduccion\env\Scripts\deactivate.nu'
